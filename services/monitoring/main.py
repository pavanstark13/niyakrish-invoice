"""Monitoring Service - FastAPI application entry point."""
...
from services.monitoring.api.v1.router import router
from services.monitoring.config import get_settings
